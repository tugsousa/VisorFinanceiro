    ...
    >
        <CardContent sx={{ p: 3, '&:last-child': { pb: 3 } }}>
            ...
            {isLoading ? (
                ...
                <Box>
                    <Typography variant="h4" sx={{ fontWeight: 'bold', color: color || '#1a2027', mt: 1, fontSize: { xs: '1.5rem', md: '1.75rem' } }}>
                        {value}
                    </Typography>
                    {subValue && (
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} lg={8}>
                    <Card 
                        ...
                        sx={{ 
                            borderRadius: 3, 
                            height: '500px', // Exact same height as Allocation
                            boxShadow: 'none', // Removed shadow
                            border: 'none',    // Removed border
                            display: 'flex', 
                    ...
                    >
                        {/* Box wrapper to ensure it fills the Card height */}
                ...
                <Grid item xs={12} lg={4}>
                    <Card 
                        ...
                        sx={{ 
                            borderRadius: 3, 
                            height: '500px', // Exact same height as Performance
                            boxShadow: 'none', // Removed shadow
                            border: 'none',    // Removed border
                            p: 3, 
                            display: 'flex', 
